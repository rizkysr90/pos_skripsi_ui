  ...
  useEffect(() => {
    const getData = async () => {
      try {
        setIsLoading(true);
        let res = await axios
          .get(`${process.env.REACT_APP_API_HOST}/productCategories`)
          .then((res) => res.data);
        setCategories(res.data);
        res = await axios
          .get(`${process.env.REACT_APP_API_HOST}/products/${productId}`)
          .then((res) => res.data);
    ...
    <>
      ...
      >
        <div className=" mt-3 rounded-lg p-4">
          <div>
            <p className="font-bold inline-block pb-2 text-2xl border-secondary border-b mb-4">
              Informasi Produk
            </p>
            <div className="form-control w-full md: max-w-md">
              ...
              <label className="label mt-4" htmlFor="product_img">
                <div className="label-text font-bold text-base">
                  Ubah Foto Produk
                </div>
            ...
            <div className="flex w-full md:max-w-md">
              ...
              <div className="form-control basis-2/5 grow mt-2">
                ...
                <label className="input-group">
                  <input
                    value={
                      products?.product_weight ? products?.product_weight : ""
                    }
                    onChange={(e) =>
                      setProducts({
                        ...products,
              ...
              <div className="form-control basis-2/5 grow mt-2 ">
                ...
                <label className="input-group ">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProducts({ ...products, sell_price: e.target.value })
                    }
                    id="sell_price"
                    name="sell_price"
                    className="input input-bordered w-full"
            ...
            <div className="form-control w-full md:max-w-md mt-2">
              <label className="label" htmlFor="description">
                <span className="label-text font-bold text-base flex justify-between items-center w-full">
                  Deskripsi
                </span>
              </label>
              <textarea
                className="textarea rounded-lg w-full textarea-bordered"
        ...
        <div className="rounded-lg p-4 mb-4">
          <div>
            ...
            <div className="form-control w-full md:max-w-md mt-2">
              ...
              <label className="input-group">
                <input
                  ...
                  placeholder="100"
                  value={
                    products?.shipping_weight ? products?.shipping_weight : ""
                  }
                  onChange={(e) =>
                    setProducts({
                      ...products,
            ...
            <label className="label mt-3" htmlFor="is_sold_online">
              <span className="label-text font-bold text-base flex justify-between items-center w-full">
                Apakah juga dijual di Toko Online?
              </span>
            </label>
            <div className="flex ml-1 items-center">
              <input
                ...
                id="ya"
                onChange={(e) =>
                  setProducts({ ...products, is_sold_online: e.target.value })
                }
                checked={products?.is_sold_online ? true : false}
              />
              <label className="ml-2 text-xs" htmlFor="ya">
                Ya
              </label>
            </div>
            <div className="flex items-center ml-1 mt-2 mb-2">
              ...
              />
              <label htmlFor="tidak" className="ml-2 text-xs">
                Tidak
              </label>
            </div>
          </div>
        ...
        <div className="flex w-full md:max-w-md justify-center">
          <button className="btn  btn-md mr-4 normal-case grow">
            Simpan & Arsipkan
          </button>
