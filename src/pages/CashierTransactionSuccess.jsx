    ...
    const getData = async () => {
      try {
        ...
        const res = await axios
          .get(`${process.env.REACT_APP_API_HOST}/ofOrders/${trxId}`)
  ...
  return (
    <>
      ...
      <div className="mt-4">
        ...
        <div className="text-sm flex justify-between mt-2">
          ...
          <div className="font-bold text-warning">
            Rp{formatRupiah(payAmount - total)}
          </div>
        </div>
      </div>
      <div className="mt-8 flex">
        <ReactToPrint
          trigger={() => (
            <div className="btn btn-primary basis-6/12 btn-sm mr-1 rounded-lg normal-case btn-outline">
              {" "}
              Cetak Struk
            </div>
          )}
        ...
        <div
          ...
          className="btn btn-primary basis-6/12 btn-sm rounded-lg normal-case"
        >
          Transaksi Baru
        </div>
      </div>
