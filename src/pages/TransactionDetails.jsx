...
function TransactionDetails() {
    ...
    const handleCancelOrder = async () => {
        try {
            setIsLoading(true);
            const res = await axios.delete(`${process.env.REACT_APP_API_HOST}/ofOrders/${transaction_id}`)
        ...
        <>
            ...
            <div className='flex flex-col text-[10px]'>
                ...
                <div className='flex justify-between opacity-70'>
                    ...
                    <div>{moment(order?.order?.createdAt).format('DD MMM YYYY, HH:mm')}</div>
                </div>
            </div>
                            ...
                            return (
                                ...
                                key={idx}>
                                    ...
                                    <div className='flex items-end'>
                                        <div>
                                            Rp{formatRupiah(elm?.sum_price_each)}
                                        </div>
                                    </div>
                                </div>
                            )
            ...
            <div className='mt-3 pb-3'>
                ...
                <div className='flex justify-between text-sm opacity-70'>
                    ...
                    <div>Rp{formatRupiah(order?.order?.pay_amount - order?.order?.amount )}</div>
                </div>
            </div>
        </>
    )
