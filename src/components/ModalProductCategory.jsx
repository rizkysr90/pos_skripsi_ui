  ...
  return (
    <>
        <div className='flex items-center justify-center w-full 
            min-h-screen z-50 fixed left-0 top-0 bg-base-300 lg:ml-44 '>
                <div className='p-8 flex  flex-col items-center bg-base-100 w-4/5 md:w-2/5'>
                    ...
                    >
                        ...
                        <div className='flex justify-center mt-4'>
                            <button type='reset' className='btn btn-warning btn-outline btn-sm mr-4 normal-case'
                            onClick={() => props.isModalOpen(false)}
                            >Batal</button>
                            {
                                 props.editableData ? 
                                 <button type='submit' className='btn btn-primary btn-sm text-white normal-case'>Simpan Perubahan</button>
                                 
                                 :
                                 <button type='submit' className='btn btn-primary btn-sm text-white normal-case'>Tambah</button>
                            }
                        </div>
                    </form>
                </div>
